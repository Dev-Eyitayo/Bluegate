...
export default function TrainingApplicationDetail() {
  ...
  if (loading) {
    return (
      <AdminLayout>
        <div className="p-8 text-center text-slate-600">Loading application details...</div>
      </AdminLayout>
    );
  }
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                <p className="font-medium text-slate-700">Attended Similar Training?</p>
                <p className="mt-1 text-sm text-slate-900">{data.similarTraining || "—"}</p>
              </div>
              <div>
                <p className="font-medium text-slate-700">Expectation</p>
                <p className="mt-1 text-sm text-slate-900 whitespace-pre-wrap">{data.expectation || "—"}</p>
              </div>
              <div>
                <p className="font-medium text-slate-700">Skills to Learn</p>
                <p className="mt-1 text-sm text-slate-900 whitespace-pre-wrap">{data.hopeToLearn || "—"}</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-3">
                ...
                >
                  <img
                    ...
                    alt="Payment proof"
                    className="w-full rounded-lg border border-slate-200 shadow-sm object-contain max-h-64"
                  />
                </a>
